...
* The randomizer will shuffle bytes around, and I'm not sure if it'll work after the randomizer modifies the ROM, so to be on the safe side just use this first
